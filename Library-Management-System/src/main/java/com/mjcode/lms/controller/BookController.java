...
import com.mjcode.lms.service.BookService;
...
public class BookController {
	...
	public ResponseEntity<Book> updateBook(@PathVariable Long id, @RequestBody Book book) {
		...
		if (existingBook != null) {
			// Update fields of existingBook with fields from `book`
	...
	public ResponseEntity<Book> borrowBook(@PathVariable Long bookId, @PathVariable Long readerId) {
		Book borrowedBook = bookService.borrowBook(bookId, readerId);
